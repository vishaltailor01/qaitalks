...
## Context Mapping (for Multi-File Changes)

When changes span multiple files, create a **Context Map** during the Analyze phase:
...
- path/to/related.ts — [relationship/dependency]
...
- Trace **dependency graphs** and ripple effects (imports, exports, type references)
- Check for **existing patterns** and conventions in similar code
- Plan the **sequence** of changes to avoid breaking intermediate states
- Identify **test coverage** for verification
- Warn about breaking changes or wide impact
